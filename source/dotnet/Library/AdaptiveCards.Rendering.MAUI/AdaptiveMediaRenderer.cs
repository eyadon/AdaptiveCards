...
//        public static View Render(AdaptiveMedia media, AdaptiveRenderContext context)
//        {
...
//        private static View RenderThumbnailPlayButton(AdaptiveRenderContext context)
//        {
...
//         *              - Volume slider
//         */
//        private static View RenderMediaPlayer(AdaptiveRenderContext context, AdaptiveMediaSource mediaSource, View uiMedia)
//        {
...
//            {
//                uiMediaPlayer.MinimumHeightRequest = _panelHeight * 2 + _childMargin * 4;
//            }
...
//            Label uiCurrentTime = new Label()
//            {
//                Text = "00:00:00",
//                TextColor = _controlForegroundColor.Color,
//                VerticalOptions = LayoutOptions.Center,
//                Margin = _marginThickness,
//            };
...
//            var uiPlaybackControlContainer = new HorizontalStackLayout()
//            {
//                VerticalOptions = LayoutOptions.Center,
...
//            var uiVolumeUnmuteButton = new Label()
//            {
//                Text = "🔇",
//                FontFamily = _symbolFontFamily,
//                FontSize = _childHeight,
...
//        private static View RenderPlaybackButton(string text)
//        {
//            return new Viewbox()
//            {
//                Width = _childHeight,
...
//            View pauseButton, View resumeButton, View replayButton)
//        {
