...
namespace AdaptiveCards.Rendering.MAUI
{
    ...
    public class AdaptiveRenderContext
    {
        ...
        public void InvokeAction(View ui, AdaptiveActionEventArgs args)
        {
            ...
            {
                ToggleShowCardVisibility((Border)ui);
                return;
            }
        ...
        public void ClickMedia(View ui, AdaptiveMediaEventArgs args)
        {
        ...
        public IDictionary<Border, View> ActionShowCards = new Dictionary<Border, View>();
        ...
        private TagContent GetTagContent(View element)
        {
            return TagAttachedProperty.GetTag(element);
        ...
        public void ToggleVisibility(IEnumerable<AdaptiveTargetElement> targetElements)
        {
            ...
            foreach (AdaptiveTargetElement targetElement in targetElements)
            {
                ...
                {
                    if (element != null && element is View elementFrameworkElement)
                    {
                        bool isCurrentlyVisible = (elementFrameworkElement.IsVisible);
                        ...
                        TagContent tagContent = TagAttachedProperty.GetTag(elementFrameworkElement);
        ...
        private View GetRenderedElement(View element)
        {
            if (element is StackLayout containerPanel)
            {
                IView uiElement = containerPanel.Children[0];

                if (uiElement is View frameworkElement)
                {
        ...
        private void HandleSeparatorAndSpacing(bool isFirstVisible, View element, TagContent tagContent)
        {
            ...
            if (separator != null)
            {
                separator.IsVisible = isFirstVisible ? false : true;
            }
        }
        ...
        public void ResetSeparatorVisibilityInsideContainer(Grid uiContainer)
        {
            ...
            foreach (View element in uiContainer.Children)
            {
        ...
        public void ToggleShowCardVisibility(Border uiAction)
        {
